...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input: </strong>1 -&gt; 3 -&gt; 4 
...
<pre style="position: relative;"><span style="font-size: 18px;"><strong>Input: </strong>1 -&gt; 5 -&gt; 2 -&gt; 9 </span>
...
<span style="font-size: 18px;">linked list is as 1 -&gt; 2 -&gt; 9.</span><div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>2 &lt;= N &lt;= 10<sup>5</sup><br>1 &lt;= x &lt;= N</span></p></div>